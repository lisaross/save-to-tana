...
export class OptionsController {
    ...
    constructor() {
        ...
        this.targetNodeIdInput = document.getElementById('targetNodeId');
        this.supertagIdInput = document.getElementById('supertagId');
        this.saveButton = document.getElementById('saveButton');
        this.tanaSchemaInput = document.getElementById('tanaSchema');
        this.extractSchemaButton = document.getElementById('extractSchemaButton');
        this.extractedFieldsDiv = document.getElementById('extractedFields');
        this.extractedFieldIdsPre = document.getElementById('extractedFieldIds');
        this.fieldIdUrlInput = document.getElementById('fieldIdUrl');
        this.fieldIdAuthorInput = document.getElementById('fieldIdAuthor');
        this.fieldIdDescriptionInput = document.getElementById('fieldIdDescription');
        this.fieldIdContentInput = document.getElementById('fieldIdContent');
     ...
     */
    loadConfiguration() {
        chrome.storage.sync.get(['apiKey', 'supertagId', 'targetNodeId', 'tanaFieldIds'], (result) => {
    ...
    extractSchemaInfo(schema) {
        ...
        if (!node)
            throw new Error('No nodes found in schema payload.');
        // Extract supertagId
        const supertagId = node.supertags?.[0]?.id || '';
        if (!supertagId)
            throw new Error('No supertag ID found in schema.');
